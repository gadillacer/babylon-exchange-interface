    ...
    <>
      ...
      >
        <span className="text-primaryText">
          ...
          :&nbsp;
          <span title={total}>{toPrecision(total as any, 3, true)}</span>
        </span>
      ...
      <fieldset className="relative flex  align-center my-2">
        <InputAmount
          ...
          max={(onChangeAmount ? curMax : null as any)}
          value={amount}
          onChangeAmount={onChangeAmount}
          disabled={disabled}
          forSwap={!!forSwap}
          price={
            tokenPrice && !ONLY_ZEROS.test(amount as any) && !isError
              ? multiply(tokenPrice, amount as any)
              : null
          }
        />
        {showSelectToken &&
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        >
          ...
          <div>
            {tokenPrice(
              price && !ONLY_ZEROS.test(amount) ? multiply(price, amount) : null as any
            )}
          </div>
        </div>
      </div>
