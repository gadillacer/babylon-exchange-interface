  ...
  return (
    ...
    >
      <Card
        padding="p-6"
        bgcolor="bg-cardBg"
        className="text-white border border-gradientFromHover outline-none flex flex-col items-center text-align-center"
      ...
      >
        ...
        <div className="text-sm pb-6 pt-1 text-align-center">
          <FormattedMessage
        ...
        <div className="flex items-center pb-2 text-align-center">
          <OutlineButton
            onClick={props.onRequestClose}
