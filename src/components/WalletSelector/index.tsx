...
import { NearWallet } from '../Icon/Wallet';
import {
  SenderWallet,
  SenderWalletLarge,
  RefWalletLarge,
...
import { InjectedSender } from '@near-wallet-selector/sender/lib/injected-sender';
...
export const WalletSelectorModal = (
  ...
  const { globalState, globalStatedispatch } = useContext(WalletContext) as any;
  ...
  return (
    <>
            ...
            connect={() => {
              ...
              if (senderInstalled) {
                ...
                getSenderWallet(window)
                  .requestSignIn(REF_FI_CONTRACT_ID)
                  .then((res: any) => {
      ...
      <SenderNotInstalledModal
        setShowSenderNotInstalled={setShowSenderNotInstalled as any}
        setShowWalletSelector={setShowWalletSelector as any}
      ...
      <ConnectingModal
        ...
        setShowConnecting={setShowConnecting as any} 
        setShowWalletSelector={setShowWalletSelector as any}
