...
const CheckedBg = () => {
  return (
    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        <linearGradient id="paint0_linear_105:1138" x1="7.5" y1="0" x2="7.5" y2="15" gradientUnits="userSpaceOnUse">
...
const Tick = () => {
  return (
    <svg width="10" height="8" viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M1 3.5L3.66667 6L9 1" stroke="white" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
};
    ...
    <svg width="37" height="37" viewBox="0 0 37 37" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        ...
        >
          ...
          <feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_106_2650" />
          <feColorMatrix
            in="SourceAlpha"
            type="matrix"
          ...
          <feBlend mode="normal" in2="effect1_backgroundBlur_106_2650" result="effect2_dropShadow_106_2650" />
          <feBlend mode="normal" in="SourceGraphic" in2="effect2_dropShadow_106_2650" result="shape" />
        </filter>
      </defs>
    </svg>
  );
...
export const UnCheckedRadio = ({ size }: { size?: string }) => {
  return (
    <div
      className={`w-${size ? size : '4'} h-${size ? size : '4'} rounded-full border border-gradientFrom bg-inputDarkBg`}
    />
  );
};
...
export const CheckedRadio = ({ size }: { size?: string }) => {
  return (
    <div
      className={`w-${size ? size : '4'} h-${size ? size : '4'} rounded-full border border-gradientFrom`}
      style={{
...
export function Radio({
  ...
  return (
    <div
      ...
      onClick={() => {
        !checked && handleSelect(value ? value : 'null');
