...
export function SwapArrow({
  ...
  const runSwapAnimation = function () {
    (upRow.current as any).style.animation = 'arrowUp 0.5s 0s ease-out 1';
    (downRow.current as any).style.animation = 'arrowDown 0.5s 0s ease-out 1';
    setMobileAnimation(true);

    (upRow.current as any).addEventListener('animationend', function () {
      (upRow.current as any).style.animation = '';
      setMobileAnimation(false);
    });
    (downRow.current as any).addEventListener('animationend', function () {
      (downRow.current as any).style.animation = '';
      setMobileAnimation(false);
    });
  };
...
export function StableSwapExchangePC({
  ...
  const runSwapAnimation = function () {
    (rightRow.current as any).style.animation = 'arrowUp 0.5s 0s ease-out 1';
    (leftRow.current as any).style.animation = 'arrowDown 0.5s 0s ease-out 1';
    setMobileAnimation(true);

    (rightRow.current as any).addEventListener('animationend', function () {
      (rightRow.current as any).style.animation = '';
      setMobileAnimation(false);
    });
    (leftRow.current as any).addEventListener('animationend', function () {
      (leftRow.current as any).style.animation = '';
      setMobileAnimation(false);
    });
  };
