...
) => (module.id === 'sender' ? 'https://sender.org/?origin=ref' : module.metadata.downloadUrl);

export const WalletNotInstalled: React.FC<WalletNotInstalledProps> = ({ module }) => {
  return (
    <div className="wallet-not-installed-wrapper">
      ...
      <div className="mx-auto text-lg">
        <span>
          <FormattedMessage id="install" defaultMessage={'Install'} /> {module.metadata.name}{' '}
      ...
      <div className="mx-auto text-xs pt-10 pb-4">
        <span>
          <FormattedMessage id="connect_to_dapps_with_one_click" defaultMessage="Connect to dApps with one click" />
        </span>
      </div>
