...
const REF_ICON = () => {
  return (
    <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M29 -2.38419e-06L22.8485 -2.92197e-06L29 6.15151L29 -2.38419e-06Z" fill="#00C6A2" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
...
export const WalletConnecting: React.FC<WalletConnectingProps> = ({ wallet, onBack }) => {
