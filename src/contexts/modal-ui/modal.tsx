...
export const setupModal = (selector: WalletSelector, options: ModalOptions): WalletSelectorModal => {
  ...
  const render = (visible = false) => {
    ReactDOM.render(
      <Wrapper>
        <Modal selector={selector} options={options} visible={visible} hide={() => render(false)} />
      </Wrapper>,
